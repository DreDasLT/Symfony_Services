...
use App\Validators\DateValidation;
...
class WeatherController extends AbstractController
{
     ...
     */
    public function index($day, LoaderService $weatherLoader, DateValidation $dateValidation): Response
    {
        $error = $day ? $dateValidation->ValidateDate($day) : null;
        $weatherData = null;
        if (!$error) {
